package us.rettopvp.cookie.util.builder;
...
public class ItemMaker implements Cloneable {
    ...
    public ItemMaker addLore(String... lore) {
        for (String s : lore) {
            this.lore.add(Messager.translate(s));
        }
        return this;
    }
    ...
    public ItemMaker setTitle(String title) {
        this.title = Messager.translate(title);
        return this;
    }
    
    public ItemMaker setLore(String... lore) {
        this.lore = Messager.translate(Arrays.asList(lore));
        return this;
    }
    ...
    public ItemMaker setLore(List<String> list) {
        this.lore = Messager.translate(list);
        return this;
    }
