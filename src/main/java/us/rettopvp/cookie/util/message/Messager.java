package us.rettopvp.cookie.util.message;
...
public class Messager {
    ...
    public static void sendStaffMessage(String... strings) {
    ...
    public static void sendAdminMessage(String... strings) {
    	for(Player player : Bukkit.getOnlinePlayers()) {
    		if(player.hasPermission("cookie.staff.admin")) {
    			for(String message : strings) {
    				player.sendMessage(translate(message));
    			}
    		}
